...
<body>
	<div class="container" style="background: #222; border-radius: 12px; padding: 15px;">
		<div class="col-md-12">
			...
			<div class="row" style="background: #3A98B9; padding: 15px">
				<div class="col-md-6" style="text-align: center; font-weight: bold; font-size: 30px">
					<h4 style="margin: 0">PHỤ KIỆN - VĂN PHÒNG PHẨM ASHION</h4>
				</div>
				<div class="col-md-6 logo" style="color: #fff">
					<p>Chào bạn <strong style="#000; text-decoration: underline;">{{$shipping_array['customer_name']}}</strong>, đơn hàng đã được xác nhận.</p>
				</div>
				<div class="col-md-12">
					<p style="color: #fff; font-size: 17px;">Bạn hoặc ai đó đã mua hàng tại shop với thông tin như sau: </p>
					...
					<p>Mã khuyến mãi được áp dụng: <strong style="text-transform: uppercase; color: #fff">{{$code['coupon_code']}}</strong></p>
					...
					<table class="table table-striped" style="border: 1px">
						...
						<tbody>
							...
							<tr>
								<td colspan="4" align="right">Tổng tiền: {{number_format($total,0,',','.')}}đ</td>
							</tr>
						</tbody>
					</table>
				</div>
				<p style="color: #fff; text-align: center;font-size: 15px;">Xem lại đơn hàng đã đặt tại: <a target="_blank" href="{{url('/history')}}">lịch sử đơn hàng của bạn</a></p>
				<p style="color: #fff">Mọichi tiết xin liên hệ<a target="_blank" href="">Shop</a> hoặc hotline: 19003658. Xin cảm ơn quý khách đã mua hàng.</p>
			</div>
		</div>
	</div>
</body>
