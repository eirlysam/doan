	...
	<div class="container">
		...
		<form action="{{URL::to('/order-place')}}" method="post">
			...
			<div class="payment-options">
				<span>
					<label><input type="checkbox" name="payment-option" value="1"> Thanh toán bằng thẻ</label>
				</span>
				<span>
					<label><input type="checkbox" name="payment-option" value="2"> Thanh toán khi nhận hàng</label>
				</span>
				<span>
					<label><input type="checkbox" name="payment-option" value="3"> Thanh toán bằng thẻ ghi nợ</label>
				</span>
				<a><input type="submit" value="Đặt hàng" name="send_order_place" class="btn btn-primary"></a>
				<!-- <span>
