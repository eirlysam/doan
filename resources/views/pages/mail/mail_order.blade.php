...
<body>
	<div class="container" style="background: #222; border-radius: 10px; padding: 15px;">
		<div class="col-md-12">
			...
			<div class="row" style="background: cadetblue; padding: 15px">
				<div class="col-md-6" style="text-align: center; font-weight: bold; font-size: 30px">
					<h4 style="margin: 0">PHỤ KIỆN - VĂN PHÒNG PHẨM MaTu - Store</h4>
				</div>
				<div class="col-md-6 logo" style="color: #fff">
					<p>Chào bạn <strong style="#000; text-decoration: underline;">{{$shipping_array['customer_name']}}</strong></p>
				</div>
				<div class="col-md-12">
				...
				<p style="color: #fff">Mọi chi tiết xin liên hệ <a target="_blank" href="">Shop</a> hoặc hotline: 19003658. Xin cảm ơn quý khách đã mua hàng.</p>
			</div>
		</div>
	</div>
</body>
